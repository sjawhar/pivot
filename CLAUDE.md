...
16. **Docstring length check:** After writing a function, count its lines (excluding docstring). If <20 lines, the docstring MUST be a single line—no Args/Returns/Examples. Count first, then write the docstring.
