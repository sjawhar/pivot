...
def test_handle_stage_failure_marks_downstream_with_notifications() -> None:
    ...
    executor_core._handle_stage_failure("stage_a", stage_states, OnError.FAIL, lifecycle)
...
def test_handle_stage_failure_without_lifecycle_still_works() -> None:
    ...
    executor_core._handle_stage_failure("stage_a", stage_states, OnError.FAIL, lifecycle=None)
