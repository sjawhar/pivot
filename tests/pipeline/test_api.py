...
from pivot import Pipeline, outputs, project, registry
...
@pytest.fixture
def mock_project_root(tmp_path: Path, mocker: MockerFixture) -> Path:
...
def test_pipeline_add_stage_registers_function(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_custom_name(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_deps_and_outs(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_duplicate_name_raises(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_params_instance(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_metrics(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_plots(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_mutex(mock_project_root: Path) -> None:
...
def test_pipeline_add_stage_with_cwd(mock_project_root: Path) -> None:
