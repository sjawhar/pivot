...
def test_parse_json_file(tmp_path: pathlib.Path) -> None:
...
def test_parse_json_file_nested(tmp_path: pathlib.Path) -> None:
...
def test_parse_yaml_file(tmp_path: pathlib.Path) -> None:
...
def test_parse_yaml_file_yml_extension(tmp_path: pathlib.Path) -> None:
...
def test_parse_csv_file(tmp_path: pathlib.Path) -> None:
...
def test_parse_csv_file_bool_values(tmp_path: pathlib.Path) -> None:
...
def test_parse_csv_file_string_values(tmp_path: pathlib.Path) -> None:
...
def test_parse_unsupported_format(tmp_path: pathlib.Path) -> None:
...
def test_parse_invalid_json(tmp_path: pathlib.Path) -> None:
...
def test_parse_yaml_non_dict(tmp_path: pathlib.Path) -> None:
...
def test_parse_json_non_dict(tmp_path: pathlib.Path) -> None:
...
def test_collect_metrics_from_files_single(tmp_path: pathlib.Path) -> None:
...
def test_collect_metrics_from_files_directory(tmp_path: pathlib.Path) -> None:
...
def test_collect_metrics_from_files_recursive(tmp_path: pathlib.Path) -> None:
...
def test_collect_metrics_from_files_not_found(tmp_path: pathlib.Path) -> None:
...
def test_format_metrics_table_json() -> None:
    ...
    result = metrics.format_metrics_table(data, "json", precision=5)
...
def test_format_metrics_table_markdown() -> None:
    ...
    result = metrics.format_metrics_table(data, "md", precision=5)
...
def test_parse_csv_file_short_rows(
...
def test_get_metric_info_from_head_no_stages(set_project_root: pathlib.Path) -> None:
